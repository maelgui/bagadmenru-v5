...
export class ProfilesApi extends runtime.BaseAPI {
     ...
     * Create Invitations
     */
    async createInvitationsApiV1InvitationsPostRaw(requestParameters: CreateInvitationsApiV1InvitationsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Invitation>> {
     ...
     * Create Invitations
     */
    async createInvitationsApiV1InvitationsPost(requestParameters: CreateInvitationsApiV1InvitationsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Invitation> {
        const response = await this.createInvitationsApiV1InvitationsPostRaw(requestParameters, initOverrides);
