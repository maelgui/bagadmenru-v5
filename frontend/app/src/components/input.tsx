...
function PrivateInput(
  ...
  return (
    <>
      <input
        ref={ref}
        className={`block w-full border-gray-200 rounded py-2 px-4 border-2 focus:outline-none focus:bg-white focus:border-pourpre-400 hover:bg-gray-50 invalid:border-red-600 ${error ? 'border-red-500' : ''}`}
