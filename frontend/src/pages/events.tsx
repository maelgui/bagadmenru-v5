...
export default function EventsPage() {
  ...
  return (
    <div>
      {data.map(event => (<div className="p-4 m-4 rounded-lg shadow-md ">
        ...
        <div className="text-center">
          ...
          <button className="mx-2 my-1 px-3 py-1 border-4 border-pourpre-500 bg-pourpre-500 text-white uppercase">Oui !</button>
          <button className="mx-2 my-1 px-3 py-1 border-4 border-pourpre-500 uppercase">Non :'(</button>
        </div>
      </div>))}
    </div>
  );
